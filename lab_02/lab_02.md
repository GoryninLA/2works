...
## Вывод
В ходе лабораторной работы я проверили работу HTTP и редиректов, реализовал REST API для "Личных заметок" на Flask, настроил Nginx как обратный прокси для API, добавил кэширование GET-запросов на 1 минуту , убедился, что API работает через Nginx и напрямую через Flask.
